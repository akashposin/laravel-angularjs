...
<html lang="en" data-ng-app="MetronicApp">
    ...
    <head>
        <title data-ng-bind="'Laravel and Angularjs | ' + $state.current.data.pageTitle"></title>
        <meta charset="utf-8" />
        ...
        <link href="{{ URL::asset('assets/global/css/components.min.css')}}" id="style_components" rel="stylesheet" type="text/css" />
	...
	<![endif]-->
        ...
        <script src="{{ URL::asset('js/directives.js')}}" type="text/javascript"></script>
